...
public let TrueTimeVersionNumber: Double = 1.0

// Project version string for TrueTime.
public let TrueTimeVersionString: String = "1.0.0"

// Domain for TrueTime errors.
public let TrueTimeErrorDomain: String = "com.instacart.TrueTimeErrorDomain"
