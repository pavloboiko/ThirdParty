...
- (UIView *)containView:(UIView *)view
{
    ...
    CGFloat constraintX = (containerView.bounds.size.width - frame.size.width) / 2.0;
    CGFloat constraintY = (containerView.bounds.size.height - frame.size.height) / 2.0;
    
    view.translatesAutoresizingMaskIntoConstraints = NO;

    [NSLayoutConstraint activateConstraints:@[
        [view.leadingAnchor constraintEqualToAnchor:containerView.leadingAnchor constant:constraintX],
        [view.trailingAnchor constraintEqualToAnchor:containerView.trailingAnchor constant:-constraintX],
        [view.topAnchor constraintEqualToAnchor:containerView.topAnchor constant:constraintY],
        [view.bottomAnchor constraintEqualToAnchor:containerView.bottomAnchor constant:-constraintY]
    ]];
...
- (UIView *)loadViewAtIndex:(NSInteger)index withContainerView:(UIView *)containerView
{
    ...
    {
        UIView *containerView = [self containView:view];
        [_contentView addSubview:containerView];
        
        containerView.translatesAutoresizingMaskIntoConstraints = NO;
        
        [NSLayoutConstraint activateConstraints:@[
            [containerView.leadingAnchor constraintEqualToAnchor:_contentView.leadingAnchor],
            [containerView.trailingAnchor constraintEqualToAnchor:_contentView.trailingAnchor],
            [containerView.topAnchor constraintEqualToAnchor:_contentView.topAnchor],
            [containerView.bottomAnchor constraintEqualToAnchor:_contentView.bottomAnchor]
        ]];
    }
