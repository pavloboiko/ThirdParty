 ...
 * Defaults to 5.0.
 */
@property (nonatomic, assign) CGFloat leftHorizontalPadding UI_APPEARANCE_SELECTOR;
@property (nonatomic, assign) CGFloat rightHorizontalPadding UI_APPEARANCE_SELECTOR;
