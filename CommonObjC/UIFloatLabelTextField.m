...
{
    // Textfield Padding
    _leftHorizontalPadding = 5.0f;
    _rightHorizontalPadding = 5.0f;
...
- (UIEdgeInsets)floatLabelInsets
{
    ...
    return UIEdgeInsetsMake(top, _leftHorizontalPadding, 0.0f, _rightHorizontalPadding);
}
...
- (void)setTextAlignment:(NSTextAlignment)textAlignment
{
    ...
    switch (textAlignment) {
        case NSTextAlignmentRight: {
            _xOrigin = CGRectGetWidth([self frame]) - CGRectGetWidth([_floatLabel frame]) - _rightHorizontalPadding;
        } break;
        ...
        default: // NSTextAlignmentLeft, NSTextAlignmentJustified, NSTextAlignmentNatural
            _xOrigin = _leftHorizontalPadding;
            break;
    }
}
